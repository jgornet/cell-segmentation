...
def get_spark(**kwargs):
    ...
    try:
        spark = (
            ...
            .config("spark.executor.extraJavaOptions", "-XX:+UseG1GC -XX:+PrintGCDetails -XX:MaxGCPauseMillis=500")
            .config("spark.driver.extraJavaOptions", "-XX:+UseG1GC -XX:+PrintGCDetails -XX:MaxGCPauseMillis=500")
            .config("spark.python.worker.reuse", "true")
